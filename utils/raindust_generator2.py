...
def rain_blur(noise, noise2, noise3, length=10, length2=10, length3=10, angle1=0,angle2=0,angle3=0, w=1,w2=1,w3=1):
    '''
    将噪声加上运动模糊,模仿雨滴
...
def add_rain(rain, img, alpha, beta):
    ...
    rain = corrupt(rain, corruption_name='defocus_blur', severity=4)
...
if __name__ == '__main__':
    image_path = r'D:\Dataset\data\genrain\b'
    image_out_path = r'D:\Dataset\data\genrain\rainy_5'
    ...
    for l in list:
        ...
        beta_random = np.random.uniform(1.5, 2.5)
        ...
        # 噪声调整
        rain = rain_blur(noise, noise2, noise3, length=length_random, length2=101, length3=1, angle1=angle_random1,
                         angle2=angle_random2,angle3=angle_random3,w=9,w2=5,w3=3)  # angle取[-25,25]
        # 图片融合
        rain1 = add_rain(rain, img, alpha=alpha_random, beta=beta_random)
        ...
        # 噪声调整
        rain = rain_blur(noise, noise2, noise3, length=length_random, length2=101, length3=1, angle1=angle_random1,
                         angle2=angle_random2, angle3=angle_random3,w=9,w2=5,w3=3)
        rain2 = add_rain(rain, img, alpha=alpha_random, beta=3)  # 方法二,加权后有玻璃外的效果,alpha调低后，噪声的黑色会显现，可以模拟黑夜
